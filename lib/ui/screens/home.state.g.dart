...
abstract class _$HomeStateCWProxy {
  ...
  HomeState listProjet(List<ProjetEntity> listProjet);
...
class _$HomeStateCWProxyImpl implements _$HomeStateCWProxy {
  ...
  HomeState call({
    ...
    Object? listProjet = const $CopyWithPlaceholder(),
  }) {
    return HomeState(
      loading: loading == const $CopyWithPlaceholder() || loading == null
          ...
          : loading as bool,
      listProjet:
          listProjet == const $CopyWithPlaceholder() || listProjet == null
              ? _value.listProjet
              // ignore: cast_nullable_to_non_nullable
              : listProjet as List<ProjetEntity>,
    );
  }
}
